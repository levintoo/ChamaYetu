                ...
                <div class="card-body">
                    ...
                    <div id="datatable_wrapper" class="dataTables_wrapper dt-bootstrap4 no-footer">
                        <div class="row">
                            ...
                            <div class="col-sm-12 col-md-6">
                                <div id="datatable_filter" class="dataTables_filter"><label>Search:<input type="search" aria-controls="datatable"></label>
                                </div>
                            </div>
                        </div>
                        <div class="row">
                            <div class="col-sm-12">
                                <table id="datatable-buttons" class="table table-bordered dt-responsive nowrap w-100""
                                       ...
                                       role="grid" aria-describedby="datatable_info" style="width: 696px;">
                                    <thead>
                                    <tr role="row">
                                    ...
                                    <tr class="even parent">
                                        <td class="dtr-control sorting_1" tabindex="0" style="">Brielle Williamson</td>
                                    ...
                                    <tr class="odd parent">
                                        <td class="sorting_1 dtr-control" style="" tabindex="0">Bruno Nash</td>
