        ...
        <div class="card card-h-100">
            <div class="card-body">
                ...
                <div class="text-nowrap">
                    <span class="badge bg-soft-success text-success">+$190.0k</span>
    ...
    <div class="col-xl-3 col-md-6">
        ...
        <div class="card card-h-100">
            ...
            <div class="card-body">
                <div class="row align-items-center">
                    <div class="col-6">
                        <span class="text-muted mb-3 lh-1 d-block text-truncate">Loan limit</span>
                        <h4 class="mb-3">
    ...
    <div class="col-xl-3 col-md-6">
        ...
        <div class="card card-h-100">
            ...
            <div class="card-body">
                <div class="row align-items-center">
                    <div class="col-6">
                        <span class="text-muted mb-3 lh-1 d-block text-truncate">Saved amount/loan balance</span>
                        <h4 class="mb-3">
